...
로그에 남긴 원본 출력은 다음 파일에서 확인할 수 있습니다.

- [logs/terminal.md](logs/terminal.md) — 터미널·권한
- [logs/docker.md](logs/docker.md) — Docker 점검·컨테이너·볼륨·바인드 마운트
- [logs/docker_web.md](logs/docker_web.md) — Dockerfile 빌드·포트 매핑
